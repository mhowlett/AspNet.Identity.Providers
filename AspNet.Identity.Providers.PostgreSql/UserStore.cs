...
namespace AspNet.Identity.Providers.PostgreSQL
{
    ...
    {
        public UserStore(PostgreSQLDatabase db, IdentityErrorDescriber describer = null) : base(db, describer) { }
    }

    public class UserStore<TUser> : UserStore<TUser, IdentityRole, PostgreSQLDatabase>
        where TUser : IdentityUser<string>, new()
    {
        public UserStore(PostgreSQLDatabase db, IdentityErrorDescriber describer = null) : base(db, describer) { }
    }

    public class UserStore<TUser, TRole, TDatabase> : UserStore<TUser, TRole, TDatabase, string>
        where TUser : IdentityUser<string>, new()
        where TRole : IdentityRole<string>, new()
        where TDatabase : PostgreSQLDatabase
    {
        public UserStore(TDatabase db, IdentityErrorDescriber describer = null) : base(db, describer) { }
    }

    public class UserStore<TUser, TRole, TDatabase, TKey> :
        ...
        where TDatabase : PostgreSQLDatabase
    {
        private UserTable<TUser, TKey> _userTable;
        private UserRolesTable<TUser, TRole, TKey> _userRolesTable;
        private RoleTable<TRole, TKey> _roleTable;
        private UserClaimsTable _userClaimsTable;
        private UserLoginsTable _userLoginsTable;

        public UserStore(TDatabase db, IdentityErrorDescriber describer = null)
        {
            if (db == null)
            {
            ...
            // todo: allow customization of column names.
            _userTable = new UserTable<TUser, TKey>(db);
            _userRolesTable = new UserRolesTable<TUser, TRole, TKey>(db);
            _roleTable = new RoleTable<TRole, TKey>(db);
            _userClaimsTable = new UserClaimsTable(db);
            _userLoginsTable = new UserLoginsTable(db);
        ...
        {
            return AutoSaveChanges ? Db.SaveChangesAsync(cancellationToken) : Task.FromResult(0);
        }
        */
        ...
        public async virtual Task<IdentityResult> UpdateAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // TODO: This is in the EF version. It's probably important.
        ...
        public async virtual Task<IdentityResult> DeleteAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _userTable.Delete(ConvertIdToString(user.Id));
        ...
        public virtual Task<TUser> FindByIdAsync(string userId, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Task.Run(() => _userTable.GetUserById(userId, ConvertIdFromString));
        ...
        public virtual Task<TUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Task.Run(() => _userTable.GetUserByName(normalizedUserName, ConvertIdFromString).FirstOrDefault());
        ...
        public async virtual Task AddToRoleAsync(TUser user, string roleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _userRolesTable.Insert(ConvertIdToString(user.Id), roleId);
        }
        ...
        public async virtual Task RemoveFromRoleAsync(TUser user, string roleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var roleId = _roleTable.GetRoleId(roleName);
            _userRolesTable.Delete(ConvertIdToString(user.Id), roleId);
        }
        ...
        public virtual async Task<IList<string>> GetRolesAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var userId = user.Id;
            return _userRolesTable.RoleNamesForUserId(ConvertIdToString(userId));
        }
        ...
        public virtual async Task<bool> IsInRoleAsync(TUser user, string roleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var roles = _userRolesTable.RoleNamesForUserId(ConvertIdToString(user.Id)).Select(a => a.ToUpper());
        ...
        public async virtual Task<IList<Claim>> GetClaimsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return _userClaimsTable.FindByUserId(ConvertIdToString(user.Id)).Claims.ToList();
        }
        ...
        public virtual Task AddClaimsAsync(TUser user, IEnumerable<Claim> claims, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                _userClaimsTable.Insert(claim, ConvertIdToString(user.Id));
            }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _userLoginsTable.Insert(ConvertIdToString(user.Id), login);
            return Task.FromResult(false);
        }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _userLoginsTable.Delete(ConvertIdToString(user.Id), loginProvider, providerKey);
        }
        ...
        public async virtual Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return _userLoginsTable.FindByUserId(ConvertIdToString(user.Id));
        }
        ...
        public virtual Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Task.Run(() => _userTable.GetUserByEmail(normalizedEmail, ConvertIdFromString).FirstOrDefault());
        }
        ...
        public async virtual Task<IList<TUser>> GetUsersInRoleAsync(string roleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var userIds = _userRolesTable.UsersInRole(roleName);
